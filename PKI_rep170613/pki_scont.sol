...
contract LuxUni_PKI {
    ...
    function newRegDatum(bytes _dataHash, address _contrAddr, string _fileName, string _description, string _linkFile, uint _encrypted, address _cryptoModule) returns (uint _regID) {
