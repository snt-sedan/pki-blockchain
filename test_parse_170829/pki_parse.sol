...
contract LuxUni_parseCert {

    //struct CertificateStatus {
    //    address addrParent;           /* address of the parent CA Smart Contract */
    //    address addrCaContract;       /* address of the parent CA Smart Contract */
    //    bytes blockchainName;
    //    bytes hashAlgo;
    //}
