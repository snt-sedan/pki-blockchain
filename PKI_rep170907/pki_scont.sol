...
contract LuxUni_PKI is owned {
    ...
    */
    function newRegDatum(bytes32 _dataHash, address _contrAddr, string _fileName, string _description,
            string _linkFile, address _nodeSender, bytes _algoHashID) onlyOwner returns(uint _regID) {
