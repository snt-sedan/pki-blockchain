...
func rstEnrollUser(w http.ResponseWriter, r *http.Request) {
	...
	*/
	...
	fmt.Printf("DEBUG before newRegDatum: fname=%v, desc=%v, newUserAddr=%v\n",
		fileName, desc, newUserAddr.String())
	...
	res, err := sess.NewRegDatum(tmpHash, contrAddr,
		fileName, desc, "", newUserAddr, []byte(""))
	if err != nil {
